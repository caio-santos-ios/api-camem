    ...
    public class DreRepository(AppDbContext context) : IDreRepository
    {
        ...
        public async Task<ResponseApi<dynamic>> GenerateAsync(DateTime startDate, DateTime endDate, string regime)
        {
            try
            {
                ...
                var accountsFilter = Builders<global::api_camem.src.Models.ChartOfAccounts>.Filter.And(
                    Builders<global::api_camem.src.Models.ChartOfAccounts>.Filter.Eq("deleted", false),
                    Builders<global::api_camem.src.Models.ChartOfAccounts>.Filter.Ne("groupDRE", ""),
                    Builders<global::api_camem.src.Models.ChartOfAccounts>.Filter.Ne("groupDRE", BsonNull.Value),
                    Builders<global::api_camem.src.Models.ChartOfAccounts>.Filter.Ne("groupDRE", "none")
                );
